...
CLOUDFLARE_R2_ACCOUNT_ID=<staging R2 account id>
CLOUDFLARE_R2_ACCESS_KEY_ID=<staging R2 access key id>
CLOUDFLARE_R2_SECRET_ACCESS_KEY=<staging R2 secret access key>
CLOUDFLARE_R2_BUCKET=<staging R2 bucket>
CLOUDFLARE_R2_PUBLIC_URL=<staging R2 public url>
