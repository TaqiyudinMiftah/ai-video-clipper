const statusStyles: Record<string, string> = {
  ...
  uploading_to_opusclip: "border-[#273746] bg-[#e8eef7] text-[#273746]",
  processing_in_opusclip: "border-[#273746] bg-[#e8eef7] text-[#273746]",
  downloading_clips: "border-[#c49d3c] bg-[#fff4cc] text-[#6f5010]",
