            ...
            <section className="rounded-xl border border-[rgba(255,180,171,0.24)] bg-[rgba(255,180,171,0.08)] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.40)] backdrop-blur-xl">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <h2 className="mt-2 font-[family-name:var(--font-display)] text-2xl font-black tracking-[-0.04em] text-white">
                    Failed work is waiting for a retry.
                  </h2>
                </div>
                <Link
                  href="/videos"
                ...
                {failedVideos.map((video) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      {video.errorMessage ? (
                        <p className="mt-1 line-clamp-2 break-words text-xs font-bold text-[#ffb4ab]">
                          {video.errorMessage}
                        </p>
                      ) : null}
                    </div>
                ...
                recentVideos.map((video) => (
                  ...
                  >
                    <span>
                      ...
                      {video.errorMessage ? (
                        <span className="mt-1 block text-sm font-bold text-[#ffb4ab]">
                          {video.errorMessage}
                        </span>
                      ) : null}
                    </span>
