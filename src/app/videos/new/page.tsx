    ...
    >
      <div className="grid gap-6 lg:grid-cols-[0.95fr_0.75fr]">
        ...
        <aside className="rounded-[2rem] border border-[color:var(--line)] bg-[#fffaf0]/80 p-6">
          <h2 className="text-2xl font-black tracking-[-0.04em]">MVP guardrails</h2>
          <div className="mt-5 grid gap-4 text-sm leading-7 text-[color:var(--muted)]">
            ...
            <p>Playwright and Composio are modular worker-side integrations. Real OpusClip selectors and production compliance review are still explicit TODOs.</p>
          </div>
        </aside>
      </div>
    </AppShell>
